#!/usr/bin/env python3
"""
Generate TCL files for GraphSAGE HLS float implementation
"""
...
PROJECT_DIR = BUILD_HLS_DIR / "graphsage_float"
TEMPLATE_DIR = HLS_DIR / "tcl_example"

# Configuration for graphsage_float
config = {
    "module_name": "graphsage_float",
    "top": "graphsage_network",
    ...
    "src": [
        str(HLS_DIR / "graphsage_layer_float.cpp"),
        str(HLS_DIR / "graphsage_layer_float.h"),
    ],
    
    # Absolute paths to testbench files
    "tb": [
        str(HLS_DIR / "testbench_float.cpp"),
    ],
